...
<script runat="server">
    ...
    public override string ModuleId { get { return Car.View_Replace; } }
    protected override void _SetInitialStates()
    {
        gw.Initialize(gv, c => c
            ...
            .TemplateField("CarriageNum", "旧车架号", new TemplateItem.Label(), f =>
            {
                f.HeaderStyle.HorizontalAlign = HorizontalAlign.Left;
                f.ItemStyle.Width = 150;
            })
            .TemplateField("EngineNum", "旧发动机号", new TemplateItem.Label(), f =>
            {
                f.HeaderStyle.HorizontalAlign = HorizontalAlign.Left;
                f.ItemStyle.Width = 100;
            })
            .TemplateField("Manufacturer", "旧品牌", new TemplateItem.Label(), f =>
            {
                f.HeaderStyle.HorizontalAlign = HorizontalAlign.Left;
                f.ItemStyle.Width = 100;
            })
            .TemplateField("Model", "旧型号", new TemplateItem.Label(), f =>
            {
                f.HeaderStyle.HorizontalAlign = HorizontalAlign.Left;
                f.ItemStyle.Width = 100;
            })
    ...
    protected override void _Execute()
    {
        ...
        gw.Execute(data, b => b
            ...
            .Do<Label>("EngineNum", (l, d, r) => l.Text = d.EngineNum)
            .Do<Label>("CarriageNum", (l, d, r) => l.Text = d.CarriageNum)
            .Do<Label>("Manufacturer", (l, d, r) => l.Text = d.Manufacturer)
            .Do<Label>("Model", (l, d, r) => l.Text = d.Model)
