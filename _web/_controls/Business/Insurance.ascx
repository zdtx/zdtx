...
<%@ Register Src="~/_controls/Car/Insurance_Update.ascx" TagPrefix="uc1" TagName="Insurance_Update" %>
...
<div style="padding: 10px;">
    ...
    <uc1:Insurance_Update runat="server" ID="u" Visible="false" />
</div>
<script runat="server">

    private string _ObjectId { get { return _ViewStateEx.Get<string>(DataStates.ObjectId, null); } }
    public override string ModuleId { get { return Business.Insurance; } }
