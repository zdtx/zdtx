...
<script runat="server">
    ...
    public override string ModuleId { get { return Business.Inspection_Batch; } }
    protected override void _SetInitialStates()
    {
        ...
        gw.Initialize(gv, c => c
            ...
            .TemplateField("License", "营运证号", new TemplateItem.DXTextBox(e =>
            {
                e.Width = 150;
            ...
            .TemplateField("LicenseRenewTime", "营运证到期日", new TemplateItem.DXDateEdit(e =>
            {
                e.Width = 150;
            ...
            .TemplateField("DrvLicense", "行驶证号", new TemplateItem.DXTextBox(e =>
            {
                e.Width = 150;
                fh.Validate(e).IsRequired();
            }), f =>
            ...
            .TemplateField("DrvLicenseRenewTime", "行驶证到期日", new TemplateItem.DXDateEdit(e =>
            {
                e.Width = 150;
                e.DisplayFormatString = e.EditFormatString = "yyyy-MM-dd";
                fh.Validate(e).IsRequired();
    ...
    protected override void _Execute(string section)
    {
        if (section == VisualSections.List)
        {
            gw.Execute(_List, b => b
                ...
                .Do<ASPxTextBox>("License", (c, d) => { c.Text = d.License; })
                .Do<ASPxDateEdit>("LicenseRenewTime", (c, d) => { c.Date = d.LicenseRenewTime; })
                .Do<ASPxTextBox>("DrvLicense", (c, d) => { c.Text = d.DrvLicense; })
                .Do<ASPxDateEdit>("DrvLicenseRenewTime", (c, d) => { c.Date = d.DrvLicenseRenewTime; })
            );
    ...
    private void _Do_Save()
    {
        ...
        _List.ForEach(d =>
        {
            ...
            {
                var yChanged =
                    o.License != d.License || o.LicenseRenewTime != d.LicenseRenewTime;
                if (yChanged) context.Create<TB_car_inspection>(_SessionEx, inspection =>
                {
                    inspection.CarId = o.Id;
                    inspection.Id = context.NewSequence<TB_car_inspection>(_SessionEx);
                    inspection.IsDrivingLicense = false;
                    inspection.License = o.License;
                    inspection.ExpiryDate = o.LicenseRenewTime;

                    o.License = d.License;
                    o.LicenseRenewTime = d.LicenseRenewTime;

                }).SubmitChanges();

                var xChanged =
                    o.DrvLicense != d.DrvLicense || o.DrvLicenseRenewTime != d.DrvLicenseRenewTime;
                if (xChanged) context.Create<TB_car_inspection>(_SessionEx, inspection =>
                {
                    inspection.CarId = o.Id;
                    inspection.Id = context.NewSequence<TB_car_inspection>(_SessionEx);
                    inspection.IsDrivingLicense = true;
                    inspection.License = o.DrvLicense;
                    inspection.ExpiryDate = o.DrvLicenseRenewTime;

                    o.DrvLicense = d.DrvLicense;
                    o.DrvLicenseRenewTime = d.DrvLicenseRenewTime;
    ...
    protected void _Do_Collect()
    {
        gw.Syn(_List, col => col
            .Do<ASPxTextBox>("License", (d, c) => d.License = c.Text)
            .Do<ASPxDateEdit>("LicenseRenewTime", (d, c) => d.LicenseRenewTime = c.Date)
            .Do<ASPxTextBox>("DrvLicense", (d, c) => d.DrvLicense = c.Text)
            .Do<ASPxDateEdit>("DrvLicenseRenewTime", (d, c) => d.DrvLicenseRenewTime = c.Date)
        );
    }
