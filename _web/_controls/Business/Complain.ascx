...
<%@ Register Src="~/_controls/Car/Complain_Edit.ascx" TagPrefix="uc1" TagName="Complain_Edit" %>
...
<div style="padding: 10px;">
    ...
    <uc1:Complain_Edit runat="server" ID="u" Visible="false" />
</div>
<script runat="server">

    private string _ObjectId { get { return _ViewStateEx.Get<string>(DataStates.ObjectId, null); } }
    public override string ModuleId { get { return Business.Complain; } }
