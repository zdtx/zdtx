...
<script runat="server">
    ...
    public override string ModuleId { get { return Business.Insurance_Batch; } }
    protected override void _SetInitialStates()
    {
        ...
        gw.Initialize(gv, c => c
            ...
            .TemplateField("InsuranceCom", "承保公司", new TemplateItem.DXTextBox(e =>
            {
                e.Width = 150;
            ...
            .TemplateField("InsuranceTransCode", "保单号", new TemplateItem.DXTextBox(e =>
            {
                e.Width = 150;
                fh.Validate(e).IsRequired();
            }), f =>
            ...
            .TemplateField("InsuranceEnd", "到期日", new TemplateItem.DXDateEdit(e =>
            {
                e.Width = 150;
            ...
            .TemplateField("Premium", "保费", new TemplateItem.DXSpinEdit(e =>
            {
                e.Width = 100;
    ...
    protected override void _Execute(string section)
    {
        if (section == VisualSections.List)
        {
            gw.Execute(_List, b => b
                ...
                .Do<ASPxTextBox>("InsuranceCom", (c, d) => { c.Text = d.InsuranceCom; })
                .Do<ASPxTextBox>("InsuranceTransCode", (c, d) => { c.Text = d.InsuranceTransCode; })
                .Do<ASPxDateEdit>("InsuranceEnd", (c, d) => { c.Date = d.InsuranceEnd; })
                .Do<ASPxSpinEdit>("Premium", (c, d) => { c.Number = d.Premium.ToCHNRounded(); })
            );
        ...
        _List.ForEach(d =>
        {
            cars.SingleOrDefault(o => o.Id == d.Id).IfNN(o =>
            {
                var changed =
                    ...
                    o.Premium != d.Premium;
                if (changed) context.Create<TB_car_insurance>(_SessionEx, insurance =>
                {
                    insurance.CarId = o.Id;
                    insurance.Id = context.NewSequence<TB_car_insurance>(_SessionEx);
                    insurance.InsuranceCom = o.InsuranceCom;
                    insurance.InsuranceTransCode = o.InsuranceTransCode;
                    insurance.InsuranceEnd = o.InsuranceEnd;
                    insurance.Premium = o.Premium;
                });
                o.InsuranceCom = d.InsuranceCom;
                o.InsuranceTransCode = d.InsuranceTransCode;
                o.InsuranceEnd = d.InsuranceEnd;
