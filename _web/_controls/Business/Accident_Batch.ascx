...
<script runat="server">
    ...
    private List<TB_car_accident> _List
    {
        get { return _ViewStateEx.Get<List<TB_car_accident>>(DataStates.List, new List<TB_car_accident>()); }
        set { _ViewStateEx.Set<List<TB_car_accident>>(value, DataStates.List); }
    }
    ...
    public override string ModuleId { get { return Business.Accident_Batch; } }
    protected override void _SetInitialStates()
    {
        ...
        gw.Initialize(gv, c => c
            ...
            .TemplateField("RespLevel", "责任划分", new TemplateItem.DXComboBox(e =>
                {
                    e.Width = 50;
                    e.FromEnum<AccidentFaultLevel>(valueAsInteger: true);
                    fh.Validate(e).IsRequired();
                }), f =>
                {
            ...
            .TemplateField("Description", "事情经过", new TemplateItem.DXTextBox(e =>
                {
                    e.Width = 200;
                }), f =>
                {
            ...
            .TemplateField("Coordinator", "现场协调人", new TemplateItem.DXTextBox(e =>
                {
                    e.Width = 60;
                    fh.Validate(e).IsRequired();
                }), f =>
            ...
            .TemplateField("ServiceCom", "维修公司", new TemplateItem.DXTextBox(e =>
                {
                    e.Width = 100;
                }), f =>
                {
            ...
            .TemplateField("Claim", "赔付金额", new TemplateItem.DXSpinEdit(e =>
                {
                    e.Width = 80;
    ...
    protected override void _Execute(string section)
    {
        if (section == VisualSections.List)
        {
            ...
            gw.Execute(data, b => b
                ...
                .Do<ASPxComboBox>("RespLevel", (c, d) => c.Value = d.RespLevel.ToStringEx())
                ...
                .Do<ASPxTextBox>("ServiceCom", (c, d) => c.Text = d.ServiceCom)
                .Do<ASPxSpinEdit>("Claim", (c, d) => c.Value = d.Claim)
            );
    ...
    private void _Do_Save()
    {
        ...
        _List.ForEach(d =>
        {
            var newId = context.NewSequence<TB_car_accident>(_SessionEx);
            context
                .Create<TB_car_accident>(_SessionEx, violation =>
                    {
                        d.FlushTo(violation);
                        violation.Id = newId;
                    })
    ...
    private void _Do_Collect()
    {
        gw.Syn(_List, col => col
            ...
            .Do<ASPxComboBox>("RespLevel", (d, c) => d.RespLevel = c.Value.ToStringEx().ToIntOrDefault(-1))
