        ...
        <div class="inner">
            <table>
                <tr>
                    ...
                    <td class="cl">
                        <dx:ASPxSpinEdit runat="server" ID="sp_Rank" Width="100" NumberType="Integer">
                            <SpinButtons ShowIncrementButtons="false" />
                        </dx:ASPxSpinEdit>
                    </td>
                    <td style="padding-left: 10px;">
                        <dx:ASPxButton runat="server" Text="查找" ID="bSearch">
                            <Image Url="~/images/_op_flatb_search.gif" />
                        </dx:ASPxButton>
                    </td>
                    <td>
                        <dx:ASPxButton runat="server" Text="导出" ID="bExport">
...
<asp:Content runat="server" ID="C" ContentPlaceHolderID="C">
    ...
    <dx:ASPxGridView ID="gv" runat="server" KeyFieldName="Id" Width="100%">
        ...
        <Columns>
            ...
            <dx:GridViewDataColumn FieldName="Name" Caption="编号" Width="120" VisibleIndex="3" />
            <dx:GridViewDataColumn FieldName="Value" Caption="值" Width="100" VisibleIndex="4" />
...
case'delete':ISEx.loadingPanel.show();break; 
            ...
            .ItemClick += (s, e) =>
            {
                ...
                {
                    case "create":
                        pop.Begin<BaseControl>("~/_controls.sys/rank/edit.ascx",
                            null, c =>
                            {
    ...
    protected override void _Execute(string section)
    {
        ...
        var exp = PredicateBuilder.True<TB_rank>();
        exp = exp.Append(tb_Name.Text.Trim(), v => exp.And(e => e.Name.Contains(v)));
        exp = exp.Append(sp_Rank.Value.ToStringEx(), v => exp.And(e => e.Value == int.Parse(v)));

        var q =
            from o in context.Ranks.Where(exp)
            select new
            {
                o.Id,
                o.Name,
        ...
        {
            _ExportToExcel("RK", q.Select(o => new
            {
                o.Id,
                o.Name,
                o.Value,
    ...
    protected override void _Do(string section, string subSection = null)
    {
        ...
        ids.ForEach(id =>
        {
            var rankId = id.ToString();
            _DTService.DeleteRank(rankId);
            _RoleProvider.DeleteRole(rankId, false);
        });
