...
<%@ Register Src="~/_controls/Driver/Create.ascx" TagPrefix="uc1" TagName="Create" %>
<%@ Register Src="~/_controls/Driver/Edit_Photo.ascx" TagPrefix="uc1" TagName="Edit_Photo" %>
...
<asp:Content runat="server" ID="W" ContentPlaceHolderID="W">
    <div class="avatar">
        <uc1:Edit_Photo runat="server" ID="cp" />
    </div>
</asp:Content>
...
<script runat="server">
        ...
        c.EventSinked += (s, eType, param) =>
        {
            switch (eType)
            {
                ...
                case BaseControl.EventTypes.Save:
                    ...
                    {
                        cp.Import<string>(c, DataStates.ObjectId);
                        if (!cp.Do(Actions.Save, false)) return;
    ...
    protected override void _Execute()
    {
        ...
        c.Execute();
        cp.ViewStateEx.Set<bool>(true, DataStates.IsCreating);
        cp.Execute();
    }
