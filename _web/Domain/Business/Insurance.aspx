...
<%@ Register Src="~/_controls/Business/Insurance.ascx" TagPrefix="uc1" TagName="Insurance" %>
<%@ Register Src="~/_controls/Business/Insurance_Batch.ascx" TagPrefix="uc1" TagName="Insurance_Batch" %>
...
<asp:Content runat="server" ID="C" ContentPlaceHolderID="C">
    <uc1:Insurance runat="server" id="c1" />
    <uc1:Insurance_Batch runat="server" id="c2" />
</asp:Content>
