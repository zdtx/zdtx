...
<%@ Register Src="~/_controls/Business/Rental.ascx" TagPrefix="uc1" TagName="Rental" %>
...
<%--                        <dx:Tab Text="其他操作">
                            <TabImage Url="~/images/_doc_16_position.gif" />
                        </dx:Tab>--%>
                    </Tabs>
                </dx:ASPxTabControl>
            </td>
...
<asp:Content runat="server" ID="C" ContentPlaceHolderID="C">
    <uc1:Rental runat="server" id="c1" />
</asp:Content>
<script runat="server"> // 承租关系指定
